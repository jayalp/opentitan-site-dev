...
and your IP address. We record this information in order to understand the
ways in which people use our website; to detect bugs; and hostile access. We
routinely delete our server logs after 30 days. We share this information only
with our website hosting service Google Cloud, who is under an obligation not to
use your information for any other purpose.

We use Plausible Analytics to learn more about the number and types of
visitors to this website. Plausible is a privacy preserving analytics
service which stores only aggregate data and does not collect any personally
identifiable information. Please see the Plausible Analytics Data Policy for
more information.
